...
/// <summary>
/// Hard benchmark configuration based on working pattern from SHA 5bb1e88.
/// Optimized for 30-60 minute total runtime with maximum statistical accuracy.
/// MemoryDiagnoser automatically provides Gen0, Gen1, Gen2, and Allocated columns.
/// </summary>
public class HardBenchmarkConfig : ManualConfig
{
    public HardBenchmarkConfig()
    {
        // High accuracy job configuration with working toolchain
        AddJob(Job.Default
            .WithToolchain(InProcessEmitToolchain.Instance)  // This was key in working version
            .WithWarmupCount(5)                              // Thorough warmup
            .WithIterationCount(10)                          // High iteration count
